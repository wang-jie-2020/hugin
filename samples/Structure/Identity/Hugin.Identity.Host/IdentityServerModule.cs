...
namespace Hugin.IdentityServer
{
    ...
    public class IdentityServerModule : AbpModule
    {
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            /*
             *  IdentityOptions 正常情况下可以，此处不可以，原因是abp将其与配置模块集成了
             *  See -- Volo.Abp.Identity.AbpIdentityOptionsManager
             *  目前暂时考虑在DataSeeder中加以配置（全局）
             */
            ...
            context.Services.ExecutePreConfiguredActions(authenticationBuilder);
