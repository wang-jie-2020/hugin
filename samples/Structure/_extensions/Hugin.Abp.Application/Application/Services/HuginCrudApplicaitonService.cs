...
namespace Hugin.Application.Services
{
    ...
    public abstract class HuginCrudApplicaitonService<TEntity, TKey, TEntityDto, TGetListInput, TEntityEditDto, TGetEditOutputDto, TCreateOrUpdateInput>
    ...
    {
        protected HuginCrudApplicaitonService(IRepository<TEntity, TKey> repository) : base(repository)
        {
        }
    }
