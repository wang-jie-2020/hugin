...
namespace LG.NetCore.Sample.BookStore
{
    public class DataSeederContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            if (!(await _bookShopRepository.AnyAsync(p => p.Code.Equals(BookStoreConsts.BookShopCodes.DangDang))))
            {
                await _bookShopRepository.InsertAsync(new BookShop(tenantId: null, userId: new Guid("2e701e62-0953-4dd3-910b-dc6cc93ccb0d"))
                {
                    Code = BookStoreConsts.BookShopCodes.DangDang,
                    Name = "当当网"
